...
def output(panel_id, output_id):
    return '{base_url}/panels/{panel_id}/outputs/{output_id}/'.format(base_url=BASE_URL, panel_id=panel_id,
                                                                      output_id=output_id)
...
def take_picture(panel_id, zone_id):
    return '{base_url}/panels/{panel_id}/zones/{zone_id}/pictures/' \
        .format(base_url=BASE_URL, panel_id=panel_id, zone_id=zone_id)
